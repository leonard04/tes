...
INSERT IGNORE INTO `activity_log` (`id`, `log_name`, `description`, `subject_type`, `subject_id`, `causer_type`, `causer_id`, `properties`, `created_at`, `updated_at`) VALUES
...
-- Dumping data for table cypher4.application_master: ~1 rows (approximately)
/*!40000 ALTER TABLE `application_master` DISABLE KEYS */;
INSERT IGNORE INTO `application_master` (`id`, `login_logo`, `dashboard_logo`, `footer_tag`, `created_at`, `deleted_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `asset_gr` (`id`, `po_id`, `po_num`, `gr_date`, `wh_id`, `created_at`, `updated_at`, `deleted_at`, `gr_by`, `notes`) VALUES
...
INSERT IGNORE INTO `asset_items` (`id`, `item_code`, `name`, `item_series`, `category_id`, `type_id`, `uom`, `price`, `supplier`, `minimal_stock`, `notes`, `specification`, `picture`, `last_wh`, `serial_number`, `location`, `purchase_date`, `bast`, `holder`, `condition`, `penalty`, `company_id`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `asset_items_update` (`id`, `id_item`, `item_code`, `name`, `item_series`, `category_id`, `type_id`, `uom`, `price`, `supplier`, `minimal_stock`, `notes`, `specification`, `picture`, `last_wh`, `serial_number`, `location`, `purchase_date`, `bast`, `holder`, `condition`, `penalty`, `company_id`, `approved_at`, `approved_by`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `asset_organization` (`id`, `category`, `name`, `address`, `telephone`, `fax`, `web`, `bank_acct`, `currency`, `pic`, `pic_email`, `created_by`, `created_at`, `updated_by`, `updated_at`, `deleted_by`, `deleted_at`, `id_product_type`, `rating`, `company_id`) VALUES
...
INSERT IGNORE INTO `asset_po_detail` (`po_num`, `item_id`, `qty`, `v1`, `v2`, `v3`, `price`, `id`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `asset_pre_detail` (`id`, `fr_id`, `pre_id`, `pre_num`, `pev_num`, `item_id`, `qty`, `delivered`, `qty_buy`, `qty_deliver`, `qty_req`, `qoh`, `qty_appr`, `qty_appr_pev`, `price`, `supp_idx`, `wh`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `asset_qty_wh` (`id`, `item_id`, `wh_id`, `qty`, `created_at`, `updated_at`, `deleted_at`, `updater`) VALUES
...
INSERT IGNORE INTO `asset_sre_detail` (`so_id`, `job_desc`, `qty`, `qty_appr`, `unit_price`, `qty_se`, `supp_idx`, `id`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`) VALUES
...
INSERT IGNORE INTO `asset_type_po` (`id`, `id_parent`, `name`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES
...
INSERT IGNORE INTO `asset_type_wo` (`id`, `id_parent`, `name`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES
...
INSERT IGNORE INTO `asset_wh` (`id`, `name`, `address`, `telephone`, `pic`, `company_id`, `created_at`, `updated_at`, `deleted_at`, `deleted_by`) VALUES
...
INSERT IGNORE INTO `asset_wo` (`id`, `wo_type`, `wo_num`, `division`, `supplier_id`, `currency`, `req_date`, `project`, `content`, `notes`, `terms`, `terms_payment`, `reference`, `deliver_to`, `deliver_time`, `discount`, `dp`, `ppn`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `approved_by`, `approved_time`, `appr_notes`, `rejected_by`, `rejected_time`, `keynumber`, `so_note`, `to_revise`, `company_id`) VALUES
...
INSERT IGNORE INTO `asset_wo_detail` (`wo_id`, `job_desc`, `qty`, `unit_price`, `solar`, `id`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `config_company` (`id`, `id_parent`, `company_name`, `npwp`, `address`, `phone`, `email`, `tag`, `bgcolor`, `p_logo`, `app_logo`, `inherit`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `config_main` (`id`, `parameter`, `value`) VALUES
	(1, 'install', 'done'),
...
INSERT IGNORE INTO `config_record_field` (`id`, `field_name`, `field_label`, `row`) VALUES
	(1, 'tanggal', 'Tanggal', 2),
	(2, 'jam', 'Jam', 3),
...
-- Dumping data for table cypher4.csr_main: ~1 rows (approximately)
/*!40000 ALTER TABLE `csr_main` DISABLE KEYS */;
INSERT IGNORE INTO `csr_main` (`id`, `author`, `date`, `title`, `deskripsi`, `online`, `pict1`, `pict2`, `pict3`, `pict4`, `pict5`, `division`, `created_at`, `updated_at`, `deleted_at`, `company_id`) VALUES
...
INSERT IGNORE INTO `do` (`id`, `from_id`, `to_id`, `deliver_date`, `deliver_by`, `project`, `notes`, `gr_no`, `approved_by`, `approved_time`, `division`, `no_do`, `created_at`, `updated_at`, `deleted_at`, `company_id`) VALUES
...
INSERT IGNORE INTO `do_detail` (`id`, `do_id`, `item_id`, `qty`, `type`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `file_managements` (`id`, `hash_code`, `file_name`, `created_at`, `created_by`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `finance_bank_loan` (`id`, `bank`, `value`, `bunga`, `start`, `period`, `type`, `currency`, `cicil_start`, `description`, `archive_by`, `archive_time`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_bank_loan_detail` (`id`, `id_loan`, `cicilan`, `bunga_rate`, `bunga`, `status`, `n_cicil`, `plan_date`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_coa` (`id`, `code`, `name`, `parent_id`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `finance_coa_history` (`id`, `id_treasure_history`, `md5`, `no_coa`, `description`, `coa_date`, `debit`, `credit`, `file_hash`, `company_id`, `approved_by`, `approved_at`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES
...
INSERT IGNORE INTO `finance_invoice_in` (`id`, `paper_id`, `paper_type`, `amount`, `amount_left`, `pay_date`, `app_date`, `status`, `project`, `plan_date`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_invoice_in_pay` (`id`, `inv_id`, `pay_num`, `amount`, `pay_date`, `description`, `paid`, `inv_date`, `inv_date_received`, `inv_number`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_inv_out` (`id_inv`, `no`, `title`, `start_periode`, `end_periode`, `company`, `periode`, `value`, `currency`, `prj_code`, `valueday`, `prefix`, `deposit`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_inv_out_print` (`id`, `id_inv_out_detail`, `description`, `unit_price`, `qty`, `uom`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.finance_leasing: ~1 rows (approximately)
/*!40000 ALTER TABLE `finance_leasing` DISABLE KEYS */;
INSERT IGNORE INTO `finance_leasing` (`id`, `subject`, `value`, `bunga`, `start`, `period`, `vendor`, `currency`, `cicil_start`, `dp`, `adm`, `insurance`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_leasing_detail` (`id`, `id_leasing`, `cicilan`, `bunga_rate`, `bunga`, `status`, `n_cicil`, `plan_date`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.finance_profit_loss_setting: ~1 rows (approximately)
/*!40000 ALTER TABLE `finance_profit_loss_setting` DISABLE KEYS */;
INSERT IGNORE INTO `finance_profit_loss_setting` (`id`, `operating_income`, `operating_expense`, `other_income`, `other_expense`, `tax`, `created_at`, `updated_at`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_schedule_payment` (`id`, `input_time`, `sp_date`, `payment_type`, `description`, `IDR`, `USD`, `PIC`, `company_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `finance_treasure` (`id`, `source`, `USD`, `IDR`, `account_usd`, `account_idr`, `type`, `br_balance`, `id_bank`, `currency`, `account_number`, `account_name`, `branch`, `address`, `bank_code`, `swift_code`, `actual_idr`, `actual_usd`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_treasure_history` (`id`, `id_treasure`, `date_input`, `description`, `IDR`, `USD`, `PIC`, `sp_date`, `sp_app`, `approved_by`, `approved_at`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_treasure_sp` (`id`, `num`, `year`, `bank`, `date1`, `date2`, `saldo`, `hold`, `approved_by`, `approved_date`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.finance_util_criteria: ~1 rows (approximately)
/*!40000 ALTER TABLE `finance_util_criteria` DISABLE KEYS */;
INSERT IGNORE INTO `finance_util_criteria` (`id`, `name`, `content`, `author`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_util_instances` (`id`, `id_master`, `subject`, `description`, `pay_date`, `currency`, `amount`, `amount_back`, `progress`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_util_master` (`id`, `subject`, `description`, `recurrent_date`, `recurrent_type`, `type`, `amount`, `currency`, `status`, `last_date`, `n_date`, `classification`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `finance_util_salary` (`id`, `salary_date`, `currency`, `amount`, `jamsostek`, `health_insurance`, `pension`, `plan_date`, `status`, `position`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.frm_comment: ~1 rows (approximately)
/*!40000 ALTER TABLE `frm_comment` DISABLE KEYS */;
INSERT IGNORE INTO `frm_comment` (`id_comment`, `id_topik`, `date_comment`, `isi_comment`, `video`, `image1`, `image2`, `emp_id`, `baca`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.frm_forum: ~1 rows (approximately)
/*!40000 ALTER TABLE `frm_forum` DISABLE KEYS */;
INSERT IGNORE INTO `frm_forum` (`id_forum`, `nama_forum`, `date_forum`, `emp_id`, `baca`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.frm_topik: ~1 rows (approximately)
/*!40000 ALTER TABLE `frm_topik` DISABLE KEYS */;
INSERT IGNORE INTO `frm_topik` (`id_topik`, `id_forum`, `emp_id`, `nama_topik`, `desc_topik`, `date_topik`, `baca`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `ha_paper_permit` (`id`, `author`, `purpose`, `nama_paper`, `kode`, `to_revise`, `issued_date`, `issued_by`, `paper_num`, `vendor`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `hrd_absen_alasan` (`absen_alasan_id`, `alasan`, `bobot`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `hrd_config` (`opt_name`, `opt_value`, `id`, `updated_at`) VALUES
...
-- Dumping data for table cypher4.hrd_cuti: ~1 rows (approximately)
/*!40000 ALTER TABLE `hrd_cuti` DISABLE KEYS */;
INSERT IGNORE INTO `hrd_cuti` (`c_id`, `id_emp`, `request_at`, `division`, `awal`, `akhir`, `keterangan`, `status`, `o_level`, `div_by`, `div_date`, `hrd_by`, `hrd_date`, `reject1`, `reject2`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `hrd_employee_history` (`id`, `emp_id`, `activity`, `act_date`, `act_by`, `act_amount`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `hrd_employee_loan` (`id`, `loan_id`, `emp_id`, `date_given`, `loan_amount`, `loan_start`, `loan_end`, `given_by`, `given_time`, `notes`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `hrd_employee_loan_payment` (`id`, `loan_id`, `date_of_payment`, `amount`, `payment_id`, `remark`, `receive_by`, `receive_time`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `hrd_employee_type` (`id`, `name`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `hrd_performa_review` (`id`, `emp_id`, `superior_id`, `review_date`, `approved_by`, `approved_date`, `review_type`, `final_score`, `entry_point`, `entry_goal`, `entry_strength`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `hrd_point` (`id`, `id_p`, `id_t`, `gp`, `bp`, `keterangan`, `status`, `date_of_case`, `hrd_approved_by`, `hrd_approved_at`, `bod_approved_by`, `bod_approved_at`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `hrd_salary_master_appreciation` (`id`, `min`, `max`, `amount`) VALUES
	(1, 5, 10, 1),
	(2, 11, 15, 2),
	(3, 16, 20, 3),
	(4, 21, 25, 4),
...
INSERT IGNORE INTO `hrd_salary_master_reason` (`id`, `reason`, `severance`, `apprecation`) VALUES
...
INSERT IGNORE INTO `hrd_salary_master_severance` (`id`, `min`, `max`, `amount`) VALUES
	(1, 3, 5, 2),
	(2, 6, 7, 4),
	(3, 8, 9, 6),
	(4, 10, 11, 7),
...
INSERT IGNORE INTO `hrd_sanction` (`id`, `sanctionID`, `emp_id`, `date_given`, `sanction_amount`, `sanction_date`, `given_by`, `given_time`, `approved_by`, `approved_time`, `notes`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.hrd_setting_point: ~1 rows (approximately)
/*!40000 ALTER TABLE `hrd_setting_point` DISABLE KEYS */;
INSERT IGNORE INTO `hrd_setting_point` (`id`, `complete_point`, `minus_point`, `max_minus_point`, `modified_by`, `date_modified`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `hrd_severance` (`id`, `emp_id`, `act_date`, `sev_date`, `id_reasons`, `sev_amount`, `app_amount`, `add_out_salary`, `add_thr`, `add_bonus`, `add_others`, `deduc_loan`, `deduc_union`, `deduc_others`, `approved_at`, `approved_by`, `rejected_at`, `rejected_by`, `updated_by`, `updated_at`, `created_by`, `created_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.hrd_training: ~1 rows (approximately)
/*!40000 ALTER TABLE `hrd_training` DISABLE KEYS */;
INSERT IGNORE INTO `hrd_training` (`id`, `title`, `description`, `type`, `complete_point`, `minus_point`, `syllabus`, `start_date`, `deadline`, `status`, `link`, `active`, `pass_score`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `hrd_training_link_video` (`id`, `id_hrd_training`, `link`, `status`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`) VALUES
...
-- Dumping data for table cypher4.hrd_training_syllabus: ~1 rows (approximately)
/*!40000 ALTER TABLE `hrd_training_syllabus` DISABLE KEYS */;
INSERT IGNORE INTO `hrd_training_syllabus` (`id`, `id_hrd_training`, `name`, `type`, `location`, `status`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `marketing_bp_detail` (`id_detail`, `id_main`, `prj_code`, `item_name`, `request_amount`, `actual_amount`, `currency`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `marketing_clients` (`id`, `company_name`, `address`, `phone_1`, `phone_2`, `fax`, `pic`, `pic_number`, `document_file`, `created_by`, `created_at`, `updated_by`, `updated_at`, `deleted_by`, `deleted_at`, `company_id`) VALUES
...
INSERT IGNORE INTO `marketing_leads` (`id`, `leads_name`, `description`, `id_client`, `id_category`, `progress`, `contributors`, `partner`, `mom`, `nda`, `spd`, `ol`, `mou`, `pks`, `approved_at`, `created_at`, `updated_at`, `deleted_at`, `approved_by`, `created_by`, `updated_by`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `marketing_leads_associates` (`id`, `id_leads`, `id_user`, `type`, `file_draft`, `file`, `file_date`, `resi`, `resi_file`, `resi_date`, `amount`, `step_type`, `id_meeting_internal`, `id_meeting_eksternal`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.marketing_leads_category: ~1 rows (approximately)
/*!40000 ALTER TABLE `marketing_leads_category` DISABLE KEYS */;
INSERT IGNORE INTO `marketing_leads_category` (`id`, `category_name`, `category_type`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `marketing_lead_files` (`id`, `id_lead`, `file_code`, `created_at`, `updated_at`, `deleted_at`, `company_id`) VALUES
...
INSERT IGNORE INTO `marketing_lead_meetings` (`id`, `id_lead`, `subject`, `description`, `attendees`, `start_time`, `duration`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `marketing_projects` (`id`, `prj_code`, `prj_name`, `id_client`, `value`, `agreement_number`, `agreement_title`, `prefix`, `address`, `currency`, `category`, `transport`, `taxi`, `rent`, `airtax`, `status`, `n_sim`, `start_time`, `end_time`, `ops_remark`, `ops_progress`, `ops_pic`, `mar_remark`, `mar_progress`, `mar_pic`, `ops_link`, `wo_attach`, `mar_link`, `to_category`, `view`, `view_subcost`, `actual_tax`, `list`, `del_list`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `mcu_log` (`id`, `mcu_id`, `name`, `uploader`, `address`, `upload_time`, `mcu_date`, `mcu_remark`, `mcu_expired`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
-- Dumping data for table cypher4.mcu_main: ~1 rows (approximately)
/*!40000 ALTER TABLE `mcu_main` DISABLE KEYS */;
INSERT IGNORE INTO `mcu_main` (`id`, `emp_id`, `created_at`, `updated_at`, `deleted_at`, `company_id`) VALUES
...
-- Dumping data for table cypher4.mtg_absence: ~1 rows (approximately)
/*!40000 ALTER TABLE `mtg_absence` DISABLE KEYS */;
INSERT IGNORE INTO `mtg_absence` (`id_absence`, `id_main`, `plan_name`, `emp_name`, `sig_address`, `redir_id`, `emp_position`, `phone`, `email`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.mtg_main: ~2 rows (approximately)
/*!40000 ALTER TABLE `mtg_main` DISABLE KEYS */;
INSERT IGNORE INTO `mtg_main` (`id_main`, `id_rv_topic`, `topic`, `location`, `date_main`, `date_end`, `progress`, `status`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
-- Dumping data for table cypher4.mtg_mom: ~1 rows (approximately)
/*!40000 ALTER TABLE `mtg_mom` DISABLE KEYS */;
INSERT IGNORE INTO `mtg_mom` (`id_mom`, `id_main`, `content`, `pic`, `deadline`, `input_time`, `floor`, `pic2`, `created_at`, `created_by`, `deleted_at`, `deleted_by`, `updated_at`, `updated_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `new_category` (`id`, `id_parent`, `name`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES
...
INSERT IGNORE INTO `notification_rules` (`id`, `notification_code`, `description`, `receivers`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
...
INSERT IGNORE INTO `policy_category` (`id_category`, `name_category`, `created_by`, `last_update_by`, `created_at`, `updated_at`, `deleted_at`, `company_id`) VALUES
...
INSERT IGNORE INTO `policy_detail` (`id_detail`, `id_policy_main`, `content`, `content_eng`, `created_by`, `attachment`, `date_detail`, `approved_by`, `approved_time`, `acknowledge_by`, `acknowledge_date`, `revision`, `created_at`, `updated_at`, `deleted_at`, `company_id`) VALUES
...
-- Dumping data for table cypher4.policy_main: ~1 rows (approximately)
/*!40000 ALTER TABLE `policy_main` DISABLE KEYS */;
INSERT IGNORE INTO `policy_main` (`id_main`, `topic`, `location`, `date_main`, `category`, `main_created_by`, `deleted_by`, `created_at`, `updated_at`, `deleted_at`, `company_id`) VALUES
...
INSERT IGNORE INTO `preference_config` (`id`, `penalty_amt`, `penalty_period`, `penalty_start`, `penalty_stop`, `period_start`, `period_end`, `absence_deduction`, `bonus_period`, `thr_period`, `odorate`, `overtime_period`, `overtime_start`, `overtime_amt`, `performa_period`, `performa_amt1`, `performa_amt2`, `performa_amt3`, `performa_amt4`, `performa_amt5`, `performa_start`, `performa_end`, `approval_start`, `btl_col`, `wo_signature`, `po_signature`, `to_signature`, `id_company`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `pref_tax_config` (`id`, `tax_name`, `formula`, `conflict_with`, `created_by`, `created_at`, `updated_by`, `updated_at`, `deleted_at`, `deleted_by`, `company_id`) VALUES
...
INSERT IGNORE INTO `record` (`id`, `tanggal`, `jam`, `id_emp`) VALUES
...
INSERT IGNORE INTO `rms_actions` (`id`, `name`, `desc`, `deleted_at`, `deleted_by`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `rms_divisions` (`id`, `id_company`, `name`, `desc`, `deleted_at`, `deleted_by`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `rms_modules` (`id`, `name`, `desc`, `deleted_at`, `deleted_by`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `rms_roles` (`id`, `id_company`, `name`, `desc`, `deleted_at`, `deleted_by`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
	(1, 1, 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
INSERT IGNORE INTO `rms_roles_divisions` (`id`, `id_company`, `id_rms_roles_divisions_parent`, `id_rms_roles`, `id_rms_divisions`, `name`, `deleted_at`, `deleted_by`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `rms_roles_privileges` (`id_rms_roles_divisions`, `id_rms_modules`, `id_rms_actions`, `deleted_at`, `deleted_by`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `rms_users_privileges` (`id_users`, `id_rms_modules`, `id_rms_actions`, `deleted_at`, `deleted_by`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
...
INSERT IGNORE INTO `users` (`id`, `company_id`, `id_rms_roles_divisions`, `name`, `email`, `position`, `user_img`, `access`, `username`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
...
-- Dumping data for table cypher4.util_decree_main: ~1 rows (approximately)
/*!40000 ALTER TABLE `util_decree_main` DISABLE KEYS */;
INSERT IGNORE INTO `util_decree_main` (`id`, `author`, `title`, `deskripsi`, `class`, `file_form`, `created_at`, `updated_at`, `deleted_at`, `company_id`) VALUES
